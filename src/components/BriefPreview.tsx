...
export function BriefPreview(): ReactElement {
  return (
    <div className="relative mx-auto w-full max-w-[430px]">
      <div className="absolute -right-4 top-24 hidden rounded-3xl bg-white p-4 shadow-[var(--shadow-card)] sm:block">
      ...
      <div className="absolute -left-5 bottom-20 hidden rounded-3xl bg-white p-4 shadow-[var(--shadow-card)] sm:block">
      ...
      <Card className="overflow-hidden border-white/80 bg-white text-right">
        <div className="bg-[var(--color-zubda-500)] p-6 text-white">
